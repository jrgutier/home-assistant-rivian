...
# Recovered from upstream during the transport merge. Our side had removed both,
# and because upstream's additions did not textually conflict git resolved the file
# to our version and dropped them with no conflict marker -- the exact silent-loss
# mode this merge was most at risk of. tests/rivian_test.py imports them.
